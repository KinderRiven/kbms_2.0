...
<head>
    ...
    <%-- my style--%>
    <link rel="stylesheet" type="text/css" href="/page/register/css/htmleaf-demo.css">
    <link rel="stylesheet" type="text/css" href="/page/register/css/register.css">
...
<div class="htmleaf-container">
    <header class="htmleaf-header">
        <h1>知识库管理系统注册<span>Upsuns</span></h1>
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    <form class="form-horizontal" action="/user_register.action">
                        <span class="heading">用户快速注册</span>
                        <div class="form-group">
                            <input type="text" class="form-control" name="user_name" placeholder="用户名或电子邮件">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" name="user_password" placeholder="再次输入密码">
                            <i class="fa fa-lock"></i>
                            <a href="#" class="fa fa-question-circle"></a>
                        </div>
                        <div class="form-group">
